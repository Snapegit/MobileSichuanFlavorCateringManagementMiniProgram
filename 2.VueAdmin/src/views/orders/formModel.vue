		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="菜品表名" prop="tablename">
							<el-input class="list_inp" v-model="form.tablename" placeholder="菜品表名"
								 type="text" 								:readonly="!isAdd||disabledForm.tablename?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="菜品id" prop="goodid">
							<el-input class="list_inp" v-model="form.goodid" placeholder="菜品id"
								 type="text" 								:readonly="!isAdd||disabledForm.goodid?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="菜品名称" prop="goodname">
							<el-input class="list_inp" v-model="form.goodname" placeholder="菜品名称"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.logistics = res.data.data.logistics?(res.data.data.logistics.replace(reg,'../../../cl35481172/file')):'';
